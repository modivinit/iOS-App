...
-(void) loginUser
{
    ...
    LoginSignupService* loginService = [[LoginSignupService alloc] init];
    loginService.mLoginSignupServiceDelegate = self;
    
    if(![loginService loginWithEmail:email password:password])
    {
