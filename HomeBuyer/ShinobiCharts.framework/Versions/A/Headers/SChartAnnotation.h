...
/** Determines if the annotation should be drawn in front of or underneath your chart data.
 ...
 In most cases, we will want the annotation to be drawn in front of the chart data, so this defaults to `SChartAnnotationAboveData`.  
 */
